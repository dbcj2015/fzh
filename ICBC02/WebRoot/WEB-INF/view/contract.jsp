...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/easyui/script/jquery.min.js"></script>
  	...
  	<style type="text/css">
  		.easyui-validatebox,.easyui-textbox,.easyui-datebox ,.easyui-numberbox,.easyui-filebox,.easyui-combobox{
  			width:170px
  		}
  		{
  			width:170px
  	...
  	<script type="text/javascript">
  		...
  		function initForm(){
  			...
  			$("#projectId").combobox({
  				url:"${pageContext.request.contextPath}/project/select",
  				textField:"fullname",
  ...
  <body>
   	...
   	<div id="dlg" style="padding:10px">
   		<form id="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/contract/create">
   			<table style="width:100%">
   				...
   				<tr>
   					...
   					<td>
   						<input id="contractFile" name="contractFile" required="true" class="easyui-textbox" validType="val_contractFile"/>
   					</td>
   				</tr>
   				<tr>
   				<!-- Ajax是无法发送具有视频,音频以及压缩包等文件 -->
   					<td style="width:70px">合同副本</td>
   					<td>
   					<!-- 后台获取上传文件名必须与name属性一致 -->
