		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				...
  				columns : [[
  					{title : "设备编号 ", field: "goodstypeId" ,width:"10%"},
  					{title : "设备类型" , field: "goodstypeName" ,width:"20%"}
  				]],
  				toolbar : "#tb" , 
  				title : "GoodsType的数据列表",
  				pagination :true,
  				fit : true,
  				striped : true,
  				singleSelect : true
	  		...
	  		$(function(){
	  			$("#btnSave").click(function(){
	  				...
	  				$("#frm").form("submit" , {//form是easyui提供的扩展函数,用于对表单进行处理
	  					url : "${pageContext.request.contextPath}/goodstype/" + opmode ,//form会自动通过ajax的方式向服务器提交数据
	  					onSubmit: function(){    
  		...
  		$(function(){
  			$("#btnDelete").click(function(){
  				...
  				$.messager.confirm("询问" , "确定要删除选中的记录吗?" , function(r){
  					if(r== true){
  						$.ajax({
  							url : "${pageContext.request.contextPath}/goodstype/delete?id=" + selectRec.goodstype_id,
  							type : "get",
  							dataType : "json" , 
