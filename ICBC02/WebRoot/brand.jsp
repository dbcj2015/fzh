		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				...
  				columns : [[
  					{title : "品牌编号" , field: "brandId" ,width:"10%"},
  					{title : "品牌名称" , field: "brandName" ,width:"20%"}
  				]],
  				toolbar : "#tb" , 
  				title : "Brand的数据列表",
  				pagination :true,
	  		...
	  		$(function(){
	  			$("#btnSave").click(function(){
	  				...
	  				$("#frm").form("submit" , {//form是easyui提供的扩展函数,用于对表单进行处理
	  					url : "${pageContext.request.contextPath}/brand/" + opmode ,//form会自动通过ajax的方式向服务器提交数据
	  					onSubmit: function(){    
  		...
  		$(function(){
  			$("#btnDelete").click(function(){
  				...
  				$.messager.confirm("询问" , "确定要删除选中的记录吗?" , function(r){
  					if(r== true){
  						$.ajax({
  							url : "${pageContext.request.contextPath}/brand/delete?id=" + selectRec.brandId,
  							type : "get",
  							dataType : "json" , 
   		...
   		<form id="frm" method="post">
   			<table style="width:100%">
   				...
   				<tr>
   					...
   					<td>
   						<input id="brandName" name="brandName" required="true" class="easyui-textbox" validType="val_brandName"/>
   					</td>
   				</tr>
   			</table>
   		</form>
