		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				...
  				columns : [[
  					{title : "模块编号" , field: "moduleId" ,width:"10%"},
  					{title : "模块名称" , field: "moduleName" ,width:"20%"},
	  		...
	  		$(function(){
	  			$("#btnSave").click(function(){
	  				...
	  				$("#frm").form("submit" , {//form是easyui提供的扩展函数,用于对表单进行处理
	  					url : "${pageContext.request.contextPath}/module/" + opmode ,//form会自动通过ajax的方式向服务器提交数据
	  					onSubmit: function(){    
  		...
  		$(function(){
  			$("#btnDelete").click(function(){
  				...
  				$.messager.confirm("询问" , "确定要删除选中的记录吗?" , function(r){
  					if(r== true){
  						$.ajax({
  							url : "${pageContext.request.contextPath}/module/delete?id=" + selectRec.moduleId,
  							type : "get",
  							dataType : "json" , 
   		...
   		<form id="frm" method="post">
   			<table style="width:100%">
   				...
   				<tr>
   					...
   					<td>
   						<input id="moduleName" name="moduleName" required="true" class="easyui-textbox" validType="val_moduleName"/>
   					</td>
   				</tr>
   				<tr>
   					<td style="width:70px">模块图标</td>
   					<td>
