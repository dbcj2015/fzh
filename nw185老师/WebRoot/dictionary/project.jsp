		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				...
  				columns : [[
  					{title : "项目名称" , field: "projectName" ,width:"20%"},
  					{title : "年份" , field: "year" ,width:"10%"}
  				]],
  				toolbar : "#tb" , 
  				title : "项目管理",
  				pagination :true,
	  		...
	  		$(function(){
	  			$("#btnSave").click(function(){
	  				...
	  				$("#frm").form("submit" , {//form是easyui提供的扩展函数,用于对表单进行处理
	  					url : "${pageContext.request.contextPath}/project/" + opmode ,//form会自动通过ajax的方式向服务器提交数据
	  					onSubmit: function(){    
  		...
  		$(function(){
  			$("#btnDelete").click(function(){
  				...
  				$.messager.confirm("询问" , "确定要删除选中的记录吗?" , function(r){
  					if(r== true){
  						$.ajax({
  							url : "${pageContext.request.contextPath}/project/delete?id=" + selectRec.projectId,
  							type : "get",
  							dataType : "json" , 
   		...
   		<form id="frm" method="post">
   			<table style="width:100%">
   				...
   				<tr>
   					...
   					<td>
   						<input id="projectName" name="projectName" required="true" class="easyui-textbox" validType="val_projectName"/>
   					</td>
   				</tr>
   				<tr>
   					<td style="width:70px">年份</td>
   					<td>
   						<input id="year" name="year" required="true" class="easyui-textbox" validType="val_year"/>
   					</td>
   				</tr>
   			</table>
   		</form>
