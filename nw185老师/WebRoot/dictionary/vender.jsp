	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/easyui/script/jquery.min.js"></script>
  	...
  	<script type="text/javascript">
		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				url : "${pageContext.request.contextPath}/vender/list",
  				columns : [[
  					{title : "编号" , field: "venderId" ,width:"10%"},
  					{title : "供应商" , field: "venderName" ,width:"20%"}
  				]],
  				toolbar : "#tb" , 
  				title : "供货商管理",
  				pagination :true,
	  		...
	  		$(function(){
	  			$("#btnSave").click(function(){
	  				...
	  				$("#frm").form("submit" , {//form是easyui提供的扩展函数,用于对表单进行处理
	  					url : "${pageContext.request.contextPath}/vender/" + opmode ,//form会自动通过ajax的方式向服务器提交数据
	  					onSubmit: function(){    
  		...
  		$(function(){
  			$("#btnDelete").click(function(){
  				...
  				$.messager.confirm("询问" , "确定要删除选中的记录吗?" , function(r){
  					if(r== true){
  						$.ajax({
  							url : "${pageContext.request.contextPath}/vender/delete?id=" + selectRec.venderId,
  							type : "get",
  							dataType : "json" , 
   		...
   		<form id="frm" method="post">
   			<table style="width:100%">
   				...
   				<tr>
   					...
   					<td>
   						<input id="venderName" name="venderName" required="true" class="easyui-textbox" validType="val_venderName"/>
   					</td>
   				</tr>
   			</table>
   		</form>
