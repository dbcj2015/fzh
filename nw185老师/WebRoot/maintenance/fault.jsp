...
<html>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/easyui/script/jquery.min.js"></script>
  	...
  	<script type="text/javascript">
		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				url : "${pageContext.request.contextPath}/asset/findByProperty?branchId=${loginuser.branch_id}&state=5&orderby=t.run_state%20desc",
  				columns : [[
					...
					{title : "设备编号" , field: "sn" ,width:"10%"},
  					...
  					{title : "设备状态" , field: "stateText" ,width:"10%"},
  					{title : "健康状况" , field: "run_state_text" ,width:"10%"}
  		...
  		$(function(){
  			...
  			$("#btnAdd").click(function(){
  				...
  				if(sel == null){
  					$.messager.alert("警告" , "请选择要报修的设备" , "warning");
  					return;
  				}
	  		...
	  		$(function(){
	  			$("#btnSave").click(function(){
	  				$("#frm").form("submit" , {
	  					url : "${pageContext.request.contextPath}/asset/fault" ,
  ...
  <body>
   	<table id="grid"></table>
   	<div id="tb">
   		<a id="btnAdd" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">报修登记</a>
   	</div>
   		...
   		<form id="frm" method="post">
   			<table style="width:100%">
				<tr>
   				...
   				<tr>
   					<td style="width:70px">报修时间</td>
   					<td>
   						<input name="faultTime" class="easyui-datebox" editable="false" required=true>
   					</td>
   				</tr>
   				...
   				<tr>
   					...
   					<td>
   						<input name="faultDescription" class="easyui-textbox" editable="true" required=true>
   					</td>
   				</tr>
   			</table>
   		</form>
