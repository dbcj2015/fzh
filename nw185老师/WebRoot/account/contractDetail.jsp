		...
		//这里是分页查询的代码
  		$(function(){
  			$("#grid").datagrid({
  				...
  				columns : [[
					{title : "" , field: "xyz" ,width:"10%" , checkbox : true},
					...
					{title : "设备品牌" , field: "brandName" ,width:"10%"},
  					...
  					{title : "当前状态" , field: "state" ,width:"10%" , formatter : function(value , rows){
  						if(value == 1){
  							return "配送中";
  						}else if(value == 2){
  							return  "在库";
  					...
  					{title : "总价" , field: "abc" ,width:"10%" , formatter : function(value , rows){
  	...
  	//这里是分页查询的代码
  		...
  		$(function(){//设备入库按钮
  			$("#btnStore").click(function(){
  				...
  				var ids = new Array();//创建一个空的JS数组
  				for(var i = 0 ; i < sels.length ; i++){
  					ids.push(sels[i].cdId);//push方法会自动向数组最后增加一个元素
  				}
  				console.info(ids);
  				//ids.join(",") 利用逗号将数组转为字符串 , 1,2,3,4,5
  				$.ajax({
