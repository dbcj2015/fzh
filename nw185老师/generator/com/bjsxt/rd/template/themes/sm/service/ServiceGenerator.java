package com.bjsxt.rd.template.themes.sm.service;
...
public class ServiceGenerator {
	public File generateFile(String profile) throws IOException, TemplateException{
		...
		if(p.getStringProperty("service.enable") != null && p.getStringProperty("service.enable").equals("false")){
			return null;
		}
		...
		File dir = new File(p.getStringProperty("baseDir") + p.getStringProperty("sourceDir") + "/" + (p.getStringProperty("basePackage") + "." + p.getStringProperty("service.package")).replace(".", "/"));
		if(!dir.exists()){
			dir.mkdirs();
		}
		File targetFile = new File(dir.getPath() + "/" + p.getStringProperty("service.class") + ".java");
	...
	public static void main(String[] args) throws IOException, TemplateException {
		System.out.println(new ServiceGenerator().generateFile("goodstype"));
	}
}
