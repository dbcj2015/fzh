  	...
  	<script type="text/javascript">
  		...
  		function initForm(){
  			...
  			$("#goodstypeId").combobox({
  				url : "${pageContext.request.contextPath}/goodstype/findByProperty" , //这里写设备类型请求地址 
  				textField : "goodstypeName" , 
  				valueField : "goodstypeId" ,
  				value : -1
  			});
  			//初始化设备品牌下拉列表框,放开注释修改url/textField/valueField即可
  			$("#brandId").combobox({
  				url : "${pageContext.request.contextPath}/brand/findByProperty" , //这里写设备品牌请求地址 
  				textField : "brandName" , 
  				valueField : "brandId" ,
  				value : -1
  			});
  		...
  		$(function(){
  			$("#grid").datagrid({
  				...
  				columns : [[
  					...
  					{title : "设备型号" , field: "productName" ,width:"20%"}
  				]],
  				toolbar : "#tb" , 
  				title : "设备型号管理",
  				pagination :true,
   		...
   		<form id="frm" method="post">
   			<table style="width:100%">
   				...
   				<tr>
   					...
   					<td>
   						<select id="goodstypeId" name="goodstypeId" required="true" validType="val_goodstypeId" class="easyui-combobox" editable="false"></select>
   					</td>
   				</tr>
   				<tr>
   					<td style="width:70px">设备品牌</td>
   					<td>
   						<select id="brandId" name="brandId" required="true" validType="val_brandId" class="easyui-combobox" editable="false"></select>
   					</td>
   				</tr>
   				<tr>
