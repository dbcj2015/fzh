...
<script type="text/javascript">
	...
	$(function(){
		btnSpan.click(function(){
			$.ajax({
				url:"thumb?newsId=${map.news_id}",
				dataType:"json",
				type:"get",
				success:function(data){
					$("#hptext").text(data.thumbsup);
				}
			});
		});
	});
...
<div class="pet_content_block">
  ...
  <h1 class="pet_article_title">${map.title}</h1>
  <div class="pet_article_user_time">发表于：${map.time}</div>
      <img src="${map.pic}"><p class=paragraph-default-p>${map.content}</p>

  </article>
        <ul class="like_share_block">
        <li><a class="link_share_button" href="###" id="btnSpan"><i class="iconfont share_ico_link">&#xe62f;</i><span id="hptext">{thumbsMap.thumbsup}</span></a></li>
