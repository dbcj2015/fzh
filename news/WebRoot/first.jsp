<!-- 如果将HTML文件转化为JSP，必须增加以下语句，然后将其关闭，再进行修改 -->
...
<div class="pet_circle_nav">
    ...
    <!-- 十个选项 -->
    	...
    	<!-- 点击之后跳转到对应界面，在地址栏可以看到发送的请求数据，并且在对应的jsp页面中通过使用:${param.键名}获取用户请求数据 -->
        	<li ><a href="contentList.jsp?channel=${ch.type_id}" class="iconfont pet_nav_xinxianshi " style="background: ${ch.color}">${ch.iconfont };</a><span>${ch.channel }</span></li>
        </c:forEach>
    </ul>
</div>
<div class="pet_content_main">
  ...
  <ul class="am-list">
     <!--缩略图在标题右边--><!-- 不同板块的最新新闻 -->
     <c:forEach items="${lastedNews }" var="l">
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="img/a1.png" alt=""></div>
                <div class="pet_list_one_info_name">${l.src} </div>
            </div>
            <div class="pet_list_one_info_r">
                <div class="pet_list_tag pet_list_tag_xxs" style="color:${l.color};border-right:0px solid ${l.color}">${l.channel }</div>
            </div>
        </div>
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
            <h3 class="am-list-item-hd pet_list_one_bt"><a href="###" class="">${l.title }</a></h3>
            <div class="am-list-item-text pet_list_one_text">${l.content}</div>

        </div>
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="${l.pic }" class="pet_list_one_img" alt=""/>
            </a>
          </div>
      </li>
      </c:forEach>
